        ...
        <div class="row ">
          <div class="col">
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action = "/test_case/store" method = "POST">
                @csrf
                <div class="card-body">
                  <div class="form-group">
                    <label for="testCaseID">Test Case ID</label>
                    <input class="form-control" name = 'test_case_id' id="testCaseID">
                  </div>
                  <div class="form-group">
                    <label for="testCaseModule">Topic</label>
                    <input class="form-control"  name = 'topic'  id="testCaseModule">
                  </div>
                  <div class="form-group">
                    <label for="testDesc">Description</label>
                    <input class="form-control" name = 'description' id="desc">
                  </div>
                  <div class="form-group">
                    <label for="testPlan">Test Plan</label>
                    <textarea class="form-control" name = 'testplan' id="testPlan" rows="6"></textarea>
                  </div>
                  {{-- <div class="form-group">
